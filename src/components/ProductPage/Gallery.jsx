...
function Gallery({ pictures }) {
  ...
  return (
    <div className="kaza__slides">
      <div className="kaza__slides__pictures">
        <img src={pictures[picture]} alt="images de l'appartement" />
      </div>
      <div
        className={
          pictures.length <= 1
            ? "kaza__slides__hiddenvector"
            : "kaza__slides__vectorleft"
        }
      >
        <img src={vectorleft} alt="flèche gauche" onClick={leftPictures} />
      </div>
      <div
        className={
          pictures.length <= 1
            ? "kaza__slides__hiddenvector"
            : "kaza__slides__vectorright"
        }
      >
        <img src={vectorright} alt="flèche droite" onClick={rightPictures} />
      </div>
    </div>
  );
}
